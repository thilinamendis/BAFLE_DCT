...
TEST_BATCH_SIZE = 40
COVER_PATH = str(Path("/home/btm0050/Research_AI_Stegno_Analysis/SteganoGan/mount/100bit/100bitdataset/test/originals/*.*").expanduser())
STEGO_PATH = str(Path("/home/btm0050/Research_AI_Stegno_Analysis/SteganoGan/mount/100bit/100bitdataset/test/stegos/*.*").expanduser())
