...
def load_train_data(cover_data_dir, stego_data_dir, batchsize=4, transform=None):
...
def load_test_data(cover_data_dir, stego_data_dir, batchsize=4, transform=None):
